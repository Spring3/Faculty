...
public class ConnectionPool {
    ...
    private static void intitDb(){
        ...
        String[] queries = new String[]{
                ...
                "CREATE TABLE IF NOT EXISTS COURSE_STUDENT (id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY, course_id INT UNSIGNED NOT NULL, student_id INT UNSIGNED NOT NULL, mark varchar(2), feedback text);"
        };
